...
Theta1_1st_column_removed = Theta1(:,2:end);
Theta2_1st_column_removed = Theta2(:,2:end);
J = J + (lambda / (2 * m))  * (sum(sum(Theta1_1st_column_removed.^2)) + sum(sum(Theta2_1st_column_removed.^2)));
